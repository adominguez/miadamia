  ...
  theme: {
    extend: {
      colors: {
        ...colors,
        primary: {
            100: lighten('#31bce9', 0.4),
            200: lighten('#31bce9', 0.3),
            300: lighten('#31bce9', 0.2),
            400: lighten('#31bce9', 0.1),
            500: '#31bce9',
            600: darken('#31bce9', 0.1),
            700: darken('#31bce9', 0.2),
            800: darken('#31bce9', 0.3),
            900: darken('#31bce9', 0.4),
        },
        secondary: {
